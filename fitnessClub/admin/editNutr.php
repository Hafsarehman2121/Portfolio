...
if(isset($_GET['consID']) && isset($_GET['status'])){
  ...
  if ($result) {
    ...
    header("location:editNutr.php?consID=".$consID);
    exit();
  }else{
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Update Nutritionists Details</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Nutritionists</a></li>
              <li class="breadcrumb-item active">Nutritionists Details</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-header">
          <h3 class="card-title" style="width:100%;">Nutritionists
            <?php 
              if($consStatus == "A"){
                ?>
                <a href="editNutr.php?consID=<?php echo $consID; ?>&status=B" class="btn btn-sm btn-danger float-right">Block User</a>
                <?php
              }else if($consStatus == "B"){
                ?>
                <a href="editNutr.php?consID=<?php echo $consID; ?>&status=A" class="btn btn-sm btn-success float-right">Active User</a>

                <?php
              }else if($consStatus == "P"){
                ?>
                <a href="editNutr.php?consID=<?php echo $consID; ?>&status=A" class="btn btn-sm btn-success float-right">Accept</a>
                <a href="editNutr.php?consID=<?php echo $consID; ?>&status=R" class="btn btn-sm btn-danger float-right">Reject</a>
                <?php
              }else if($consStatus == "R"){
                ?>
                <a href="editNutr.php?consID=<?php echo $consID; ?>&status=P" class="btn btn-sm btn-success float-right">Accept</a>
                <?php
              }
             ?>
