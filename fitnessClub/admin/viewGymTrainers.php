        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">All Gym Trainers List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">All Gym Trainers Data</h3>

        
        </div>
        <div class="card-body">
          
           <table id="gymTrainer" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                    <th>Sr #</th>
                    <th>Name</th>
                  ...
                  <?php 
                    $sql = "SELECT * FROM `tbl_consultants` WHERE `cons_type`='GT' ORDER BY `cons_id` DESC";
                      ...
                      if (mysqli_num_rows($result)>0) {
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="editGT.php?consID=<?php echo $row['cons_id']; ?>" class="btn btn-success btn-sm">Edit</a>
...
<script>
  $(function () {
    $("#gymTrainer").DataTable({
      "responsive": true, "lengthChange": false, "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"]
    }).buttons().container().appendTo('gymTrainer  _wrapper .col-md-6:eq(0)');
    $('#example2').DataTable({
      "paging": true,
      "lengthChange": false,
      "searching": false,
